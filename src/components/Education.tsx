  ...
  return (
    <section id="education" className="py-24 relative bg-transparent">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        {/* Timeline Wrapper */}
        <div className="relative border-l border-border ml-4 md:ml-32">
          {educationList.map((edu, idx) => (
            ...
            >
              ...
              <div className="absolute -left-[11px] top-1.5 p-1 rounded-full bg-bg border-2 border-primary z-10">
              ...
              <div className="glass-card p-6 rounded-xl relative">
                ...
                <div className="hidden md:block absolute -left-36 top-1/2 -translate-y-1/2 text-right w-28">
                  <div className="flex items-center justify-end gap-1.5 text-xs font-semibold text-secondary">
                ...
                {/* Mobile Year Badge */}
                <div className="md:hidden flex items-center gap-1.5 text-xs font-semibold text-secondary mb-2">
                  <Calendar className="h-3.5 w-3.5" />
                  {edu.duration}
                </div>
                ...
                {/* School */}
                <span className="inline-block text-sm font-semibold text-secondary mt-1">
                  {edu.institution}
                </span>
